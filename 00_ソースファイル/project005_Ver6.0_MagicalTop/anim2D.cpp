...
//	オーバーロードコンストラクタ
//============================================================
CAnim2D::CAnim2D(const CObject::LABEL label, const int nPriority) : CObject2D(label, nPriority)
{
	// メンバ変数をクリア
	m_nCounter		= 0;	// アニメーションカウンター
	m_nCntChange	= 0;	// パターン変更カウント
...
//	初期化処理 (オーバーロード)
//============================================================
HRESULT CAnim2D::Init(const int nWidthPtrn, const int nHeightPtrn)
{
	// メンバ変数を初期化
	m_nCounter		= 0;		// アニメーションカウンター
	m_nCntChange	= 0;		// パターン変更カウント
	...
	// メンバ変数を設定
	m_nMaxPtrn	= nWidthPtrn * nHeightPtrn;	// パターンの総数

	m_nWidthPtrn	= nWidthPtrn;	// テクスチャの横の分割数
	m_nHeightPtrn	= nHeightPtrn;	// テクスチャの縦の分割数
...
//	位置の設定処理
//============================================================
void CAnim2D::SetPosition(const D3DXVECTOR3& rPos)
{
	// 位置の設定
	CObject2D::SetPosition(rPos);
...
//	向きの設定処理
//============================================================
void CAnim2D::SetRotation(const D3DXVECTOR3& rRot)
{
	// 向きの設定
	CObject2D::SetRotation(rRot);
...
//	大きさの設定処理
//============================================================
void CAnim2D::SetScaling(const D3DXVECTOR3& rSize)
{
	// 大きさの設定
	CObject2D::SetScaling(rSize);
