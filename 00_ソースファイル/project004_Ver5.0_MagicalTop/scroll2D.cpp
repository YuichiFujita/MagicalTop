...
//	オーバーロードコンストラクタ
//============================================================
CScroll2D::CScroll2D(const CObject::LABEL label, const int nPriority) : CObject2D(label, nPriority)
{
	// メンバ変数をクリア
	m_fTexU  = 0.0f;	// テクスチャ横座標の開始位置
	m_fTexV  = 0.0f;	// テクスチャ縦座標の開始位置
...
//	位置の設定処理
//============================================================
void CScroll2D::SetPosition(const D3DXVECTOR3& rPos)
{
	// 位置の設定
...
//	向きの設定処理
//============================================================
void CScroll2D::SetRotation(const D3DXVECTOR3& rRot)
{
	// 向きの設定
...
//	大きさの設定処理
//============================================================
void CScroll2D::SetScaling(const D3DXVECTOR3& rSize)
{
	// 大きさの設定
