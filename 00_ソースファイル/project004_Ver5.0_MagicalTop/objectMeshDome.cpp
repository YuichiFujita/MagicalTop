...
//	オーバーロードコンストラクタ
//============================================================
CObjectMeshDome::CObjectMeshDome(const CObject::LABEL label, const int nPriority) : CObject(label, nPriority)
{
	// メンバ変数をクリア
	m_pVtxBuff = NULL;		// 頂点バッファ
	m_pIdxBuff = NULL;		// インデックスバッファ
...
//	位置の設定処理
//============================================================
void CObjectMeshDome::SetPosition(const D3DXVECTOR3& rPos)
{
	// 引数の位置を設定
	m_meshDome.pos = rPos;
}
...
//	向きの設定処理
//============================================================
void CObjectMeshDome::SetRotation(const D3DXVECTOR3& rRot)
{
	// 引数の向きを設定
	m_meshDome.rot = rRot;
...
//	位置取得処理
//============================================================
D3DXVECTOR3 CObjectMeshDome::GetPosition(void) const
{
	// 位置を返す
...
//	向き取得処理
//============================================================
D3DXVECTOR3 CObjectMeshDome::GetRotation(void) const
{
	// 向きを返す
...
void CObjectMeshDome::SetIdx(void)
{
	...
	{ // 使用中の場合
		...
		{ // 横の分割数 +1回繰り返す
			...
			pIdx[0] = ((m_part.x + 1) * (m_part.y - 1)) + nCntWidth;
