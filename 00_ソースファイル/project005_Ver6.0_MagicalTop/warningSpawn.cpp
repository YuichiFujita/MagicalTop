...
#define FADEIN_CNT	(60)	// フェードイン開始待機フレーム
#define SET_SCALE	(18.0f)	// 拡大率の初期値
#define SUB_SCALE	(1.5f)	// 拡大率の減算量
#define SUB_FADE	(0.06f)	// フェードのα値の減算量

//************************************************************
//	静的メンバ変数宣言
//************************************************************
const char *CWarningSpawn::mc_apTextureFile[] =	// テクスチャ定数
{
	"data\\TEXTURE\\warningSpawn000.png",	// 警告表示テクスチャ
};

//************************************************************
//	子クラス [CWarningSpawn] のメンバ関数
//************************************************************
//============================================================
//	コンストラクタ
//============================================================
...
{
	// ポインタを宣言
	CWarningSpawn *pWarningSpawn = NULL;	// 出現警告表示生成用

	if (UNUSED(pWarningSpawn))
	{ // 使用されていない場合

		// メモリ確保
		pWarningSpawn = new CWarningSpawn;	// 出現警告表示
	}
