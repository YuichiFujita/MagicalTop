...
//	位置の設定処理
//============================================================
void CObject2D::SetPosition(const D3DXVECTOR3& rPos)
{
	// 引数の位置を設定
	m_pos = rPos;
...
//	向きの設定処理
//============================================================
void CObject2D::SetRotation(const D3DXVECTOR3& rRot)
{
	// 引数の向きを設定
	m_rot = rRot;
...
//	大きさの設定処理
//============================================================
void CObject2D::SetScaling(const D3DXVECTOR3& rSize)
{
	// 引数の大きさを代入
	m_size = rSize;
...
//	大きさ取得処理
//============================================================
D3DXVECTOR3 CObject2D::GetScaling(void) const
{
	// 大きさを返す
	return m_size;
}
