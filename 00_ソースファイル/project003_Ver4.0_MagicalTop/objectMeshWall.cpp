...
//	オーバーロードコンストラクタ
//============================================================
CObjectMeshWall::CObjectMeshWall(const CObject::LABEL label, const int nPriority) : CObject(label, nPriority)
{
	// メンバ変数をクリア
	m_pVtxBuff = NULL;		// 頂点バッファ
	m_pIdxBuff = NULL;		// インデックスバッファ
...
//	位置の設定処理
//============================================================
void CObjectMeshWall::SetPosition(const D3DXVECTOR3& rPos)
{
	// 引数の位置を設定
	m_meshWall.pos = rPos;
}
...
//	向きの設定処理
//============================================================
void CObjectMeshWall::SetRotation(const D3DXVECTOR3& rRot)
{
	// 引数の向きを設定
	m_meshWall.rot = rRot;

	// 向きの正規化
	useful::NormalizeRot(m_meshWall.rot.z);
}

//============================================================
//	大きさの設定処理
//============================================================
void CObjectMeshWall::SetScalingBiaxial(const D3DXVECTOR2& rSize)
{
	// 引数の大きさを設定
...
//	位置取得処理
//============================================================
D3DXVECTOR3 CObjectMeshWall::GetPosition(void) const
{
	// 位置を返す
...
//	向き取得処理
//============================================================
D3DXVECTOR3 CObjectMeshWall::GetRotation(void) const
{
	// 向きを返す
...
//	大きさ取得処理
//============================================================
D3DXVECTOR2 CObjectMeshWall::GetScalingBiaxial(void) const
{
	// 大きさを返す
